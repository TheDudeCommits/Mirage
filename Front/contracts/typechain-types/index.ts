...
export type { ContentAuthenticityRegistry } from "./src/ContentAuthenticityRegistry";
export { ContentAuthenticityRegistry__factory } from "./factories/src/ContentAuthenticityRegistry__factory";
